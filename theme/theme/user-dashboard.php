      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="   ">
            ...
            <span class="h6 w-60 rounded-top w-100 d-inline-block bg-dark text-white  ">Starter</span>
            <div class="bg-transparent card-header pt-0 border-0 mb-2">
                <h1 class="h1 font-weight-normal text-dark prc-text text-center mb-0"><i class="fa fa-dollar"></i><span class="price">3</span><span class="h6 ml-2">/ per month</span></h1>
            </div>
            <div class="card-body us-pkg-txt pt-0">
                ...
                <button type="button" class="btn btn-outline-secondary mb-3">Downgrade</button>
                <button type="button" class="btn btn-outline-secondary mb-3">Upgrade</button>
            </div>
        </div>
              </div>
            </div>
        </div>
         <div class="col-lg-8 min-table-min-sec-user-min" >
