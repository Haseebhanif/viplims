<?php include 'head.php';?>
  ...
  <section class="w-100     signup-form-min-frm-asn-min pt-0">
    ...
    <div class="card-text">
       <form class="logn-asn-min">
        ...
        <div class="form-group wow fadeInDown" data-wow-duration="1000ms" >
          ...
          <div class="form-group wow fadeInDown animated mt-2 mb-0" data-wow-duration="1000ms">
        ...
        <div class="container p-0">
          <div class="row">
            <div class="col-md-6 col-xs-12 text-sm-center wow fadeInDown" data-wow-duration="1000ms"> <label class="form-check-label d-inline-block pull-left"><input type="checkbox" class="h-auto mt-1"> Remember me</label></div>
            <div class="col-md-6 col-xs-12 wow fadeInDown " data-wow-duration="1000ms">
              <a href="#" class="pull-left d-inline-block pull-right ft-12 frg-pass text-decoration-none">Forgot your password?</a>
            </div>
          </div>
        </div>
        <button type="submit" class="btn btn-primary d-inline-block w-100 mt-2 btn-block wow fadeInDown" data-wow-duration="1000ms" >Log in</button>
        <span class="SeparatorRow mt-2 mb-2"><span class="SeparatorRow-horizontalLine"></span><span class="SeparatorRow-label Label">or</span><span class="SeparatorRow-horizontalLine"></span></span>
         <button type="submit" class="btn btn-primary d-inline-block w-100  bg-white text-dark btn-block wow fadeInDown" data-wow-duration="1000ms" >Register</button>
...
<div class="loginfooter">
  <nav>
  <ul>
    <li><a href="javascript:;"><span>Viplims.com</span></a></li>
    <li><a href="javascript:;"><span>Support</span></a></li>
    <li><a href="javascript:;"><span>Integrations</span></a></li>
    <li><a href="javascript:;"><span>Forum</span></a></li>
    <li><a href="javascript:;"><span>Developers &amp; API</span></a></li>
  </ul>
</nav>
</div>
</div>
