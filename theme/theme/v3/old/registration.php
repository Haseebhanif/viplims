<?php include 'head.php';?>
  ...
  <section class="w-100 login-min reg-min-frm-min pt-0">
    ...
    <p class="hint-text wow fadeInDown" data-wow-duration="1000ms">Get started with your free account.</p>
        <div class="form-group mb-0">
      <div class="row">
        <div class="form-group wow col-md-6 fadeInDown" data-wow-duration="1000ms"><input type="text" class="form-control" name="first_name" placeholder="First Name" required="required" ></div>
        <div class="form-group col-md-6 wow fadeInDown" data-wow-duration="1500ms"><input type="text" class="form-control" name="last_name" placeholder="Last Name"  required="required"></div>
      </div>          
        </div>
    ...
    <div class="form-group wow fadeInDown" data-wow-duration="1000ms">
            <input type="password wow fadeInDown" data-wow-duration="1000ms" class="form-control" name="password" placeholder="Password"  required="required">
        </div>
    <div class="form-group wow fadeInDown" data-wow-duration="1000ms">
            <input type="password wow fadeInDown" data-wow-duration="1000ms" class="form-control" name="confirm_password" placeholder="Confirm Password"  required="required">
        </div>        
        <div class="form-group wow fadeInDown" data-wow-duration="1000ms">
      <label class="form-check-label"><input type="checkbox" > I accept the <a href="javascript:;">Terms of Use</a> &amp; <a href="javascript:;">Privacy Policy</a></label>
    </div>
    <div class="form-group">
            <button type="submit" class="btn btn-dark btn-lg btn-block wow fadeInDown" data-wow-duration="1000ms">Register Now</button>
        </div>
        <div class="text-center">Already have an account? <a class="text-decoration-none" href="login.php">Sign in</a></div>
    </form>
