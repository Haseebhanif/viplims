                    ...
                    <div class="container ">
                        <div class="row">
                            <div class="title  w-100 mb-3">
                                <h2 class="pull-left mt-0 mb-0 d-inline-block">Edit {{$page->title}}</h2>
                                ...
                                <div class="signup-form-min-frm pb-0 pt-5 col-md-12 m-0-auto">
                                    {!! Form::open(['route' => ['pages.update',$page->id], 'class'=>'pb-4', 'method' => 'post','enctype'=>'multipart/form-data']) !!}
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           name="title" value="{{$page->title}}" placeholder="Title" id="title">
                                                    @error('title')
                                      ...
                                      <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <label>Slug</label>
                                                    <input type="text" name="slug" value="{{$page->slug}}" placeholder="Slug"
                                                           id="slug" class="w-100 form-control @error('slug') is-invalid @enderror">
{{--                                                    <small><code>http://domain.com/your-slug</code> Only a-z, numbers, hypen allowed</small>--}}
                                      ...
                                      <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="text" name="meta_title" value="{{$page->meta_title}}" placeholder="Meta Title"
                                                        ...
                                                        <div class="form-group wow w-100 fadeInDown mt-3 mb-0"
                                                            ...
                                                            <label class="form-check-label" for="is_parent">
                                                                <input class=" form-check-inline" type="checkbox" id="is_parent"
                                                                       name="is_parent" {{$page->is_parent == 1 ? 'checked' : ''}}  value="1" v-model="checked">
                                                                Is Parent?
                                                            </label>
                                                            @error('is_parent')
                                                            <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group wow w-100 fadeInDown mt-3 mb-0"
                                                            ...
                                                            <label class="form-check-label" for="show_bottom">
                                                                <input class=" form-check-inline @error('show_bottom') is-invalid @enderror" {{$page->show_bottom == 1 ? 'checked' : ''}} value="1" type="checkbox"
                                                                       name="show_bottom">
                                                                Show Bottom?
                                                            </label>
                                                            @error('sow_bottom')
                                      ...
                                      <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="number" name="priority" placeholder="Priority" value="{{$page->priority}}"
                                      ...
                                      <strong>{{ $message }}</strong>
                                        ...
                                        <div class="row" v-if="checked==false">
                                            ...
                                            <div class="form-group wow w-100 fadeInDown"
                                                ...
                                                <input type="text" value="{{$page->meta_description}}"
                                                    ...
                                                    <select name="parent_page"
                                                        ...
                                                        @if(!($headings)->isEmpty())
                                                            @foreach($headings as $headings)
                                                                <option value="{{$headings->id}}" {{$page->parent_page == $headings->id ? 'selected' : ''}}>{{$headings->title}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                    @error('parent_page')
                                      ...
                                      <strong>{{ $message }}</strong>
                                        ...
                                        <div class="row" v-if="checked==false">
                                        <div class="col-lg-12">
                                            <div class="row-editor fadeInDown"
                                                 data-wow-duration="1000ms">
                                                <label>Content</label>
                                                        <textarea
