                    ...
                    <div class="container ">
                        <div class="row">
                            <div class="title  w-100 mb-3">
                                <h2 class="pull-left mt-0 mb-0 d-inline-block">Cards</h2>
                                    ...
                                    <tr class="wow fadeInDown" data-wow-duration="1200ms">
                                        ...
                                        <td>
                                            <ul class="action-icon-min">
                                                <li><a href="{{route('cards.edit',$card->id)}}" title="Edit"><i
                                                            class="fa fa-pencil-square-o"></i></a></li>
                                                <li><a href="{{route('cards.destroy',$card->id)}}" title="Delete"><i class="fa fa-trash"
