                    ...
                    <div class="container ">
                        <div class="row">
                            <div class="title  w-100 mb-3">
                                <h2 class="pull-left mt-0 mb-0 d-inline-block">Create Card</h2>
                                ...
                                <div class="signup-form-min-frm pb-0 pt-5 col-md-12 m-0-auto">
                                    {!! Form::model($card,['route' => ['cards.update',$card->id], 'class'=>'pb-4', 'method' => 'put','enctype'=>'multipart/form-data']) !!}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           name="type" value="{{$card->type}}" placeholder="Type">
                                                    @error('type')
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           name="title" value="{{$card->title}}" placeholder="Title">
                                                    @error('title')
                                                    <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                      </span>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group wow w-100 fadeInDown"
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           name="link" value="{{$card->link}}" placeholder="Link">
                                                    @error('link')
                                                    <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                      </span>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row-editor  @error('text') is-invalid @enderror fadeInDown"
                                                    ...
                                                    <label class="checkbox-inline">
                                                        <input type="radio" name="status" {{$card->status ==1 ?'checked':''}} value="1"> Active
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <input type="radio" name="status" {{$card->status==0?'checked' : ''}} value="0"> Disabled
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
