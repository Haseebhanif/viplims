<?php
	...
	$data = file_get_contents("https://viplims.com/hospital/ViewReportPDF/9/doc");
...
<p>Enter/paste your document here:</p>
  ...
  <div class="page-orientation">
    ...
    <label><input type="radio" name="orientation" checked="checked" value="landscape">Landscape</label>
  </div>
