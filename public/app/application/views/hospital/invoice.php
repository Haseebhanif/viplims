...
<head>
	...
	<title>Hospital Invoices - Lims</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9">
                                                        <div class="numbers">
                                                            ...
                                                            <?php  if(empty($TotalValue)){ echo '0';}else{ echo $TotalValue ;} ;  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9">
                                                        <div class="numbers">
                                                            ...
                                                            <?php  if(empty($PaidValue)){ echo '0';}else{ echo $PaidValue ;} ;  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9">
                                                        <div class="numbers">
                                                            ...
                                                            <?php  if(empty($UnPaidValue)){ echo '0';}else{ echo $UnPaidValue ;} ;  ?>
                                    ...
                                    <form method='get'>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control border-input" name="startdate" >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>End Date</label>
                                                    <input type="date" class="form-control border-input" name="enddate" >
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="submit" value="Submit" class="mt-2 btn btn-outline-danger btn-theme">
                                                 ...
                                                 <a href="<?php echo base_url();?>hospital/HospitalInvoice" class="mt-2 btn btn-outline-danger btn-theme">Reset</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-content"><span class="text-theme  bootstrap-table">Invoices</span>
                                    <div class="toolbar">
                                        <!--Here you can write extra buttons/actions for the toolbar-->
                                    </div>
                                    <table id="bootstrap-table" class="table-striped">
                                        <thead>
                                            <th data-field="actions">Invoice</th>
                                            ...
                                            <th data-field="referring" data-sortable="true">Doctor</th>
                                        ...
                                        <?php foreach($jobDetails as $job){ ?>
                                            ...
                                            <?php if($job->hospital_sent == 1){?>
                                            <a  target='_blank' class="btn btn-outline-danger btn-theme" href="<?php echo base_url();?>hospital/viewInvoice/<?php echo $job->test_id?>">
                                                View Invoice
                                            </a>
                                            <?php }?>
                                             </td>
                                            ...
                                            <td>
                                                <?php if($job->hospital_paid == 1){?>
                                               <div class="checkbox ">
                                                    <input id="checkbox1" checked disabled type="checkbox">
                                                    <label for="checkbox1" ></label>
                                                </div>
                                            <?php }else{?>
                                                 <div class="checkbox ">
                                                    <input id="checkbox1" disabled type="checkbox">
                                                    <label for="checkbox1" ></label>
                                                </div>
                                           <?php }?>
                                                ...
                                                <td><a  class="profile_link" href="<?php echo base_url();?>user/PatientDetails/<?php echo $job->patient_id?>"><?php echo $job->patient_name." ".$job->last_name ;?></a> <br /><small> DOB: <?php $date=date_create($job->DateOfBirth); echo date_format($date,$dateFormat); ?></td>
                            ...
                            <?php if(!empty($this->input->get('startdate'))){
                             ...
                             <a href="<?php echo base_url();?>hospital/AllHospitalInvoiceexport<?php echo $startdate.$enddate; ?>" class="btn btn-outline-danger btn-theme mb-5 btn-wd">Export Invoice CSV</a>
