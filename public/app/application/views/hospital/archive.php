                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content"><span class="text-theme  bootstrap-table">Archive</span>
                                    <div class="toolbar">
     ...
     $(document).ready(function(){
       $('.RemoveFromArchive').click(function(){ 
          var postId = $(this).attr("value");
            ...
            $.ajax({url: "<?php echo base_url();?>hospital/RemoveFromArchive?Post_id="+postId, success: function(result){
                $("#"+postId).remove();                    
            } 
