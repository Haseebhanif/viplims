  ...
  <div class="wrapper ">
   ...
   <div class="content">
              <div class="container-fluid">
                ...
                <form method="post" action="<?php echo base_url();?>admin/addNewJob" accept-charset="utf-8" enctype="multipart/form-data">
                  ...
                  <div class="col-md-4 <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pl-1"; }?>">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email_address"  placeholder="patient@gmail.com">
                      </div>
                    </div>
                   ...
                   <div class="row">
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pr-1"; }?>">
                       ...
                       <select class="form-control" name="gender" required="">
                          ...
                          <option value="Nor">Not Specified</option>
                        </select>
                      </div>
                    </div>
                      <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "px-1"; }?>">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mob_number" placeholder="Mobile number" >
                      </div>
                    </div>
                      <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pl-1"; }?>">
                      <div class="form-group">
                    ...
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "px-1"; }?>">
                     ...
                     <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pl-1"; }?>">
                      <div class="form-group">
                        ...
                        <input type="Date" class="form-control datepicker" name="DOB" placeholder="mm/dd/yyyy" required="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pr-1"; }?>">
                      <div class="form-group">
                        <label>Referring institution  <span class="text-theme">* </span>[<a class='ajax ' href="<?php echo base_url();?>admin/AddHospital?appview">Add institute</a>]</label>
                    ...
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pl-1"; }?>">
                      <div class="form-group">
                        <label>Date received  <span class="text-theme">*</span></label>
                          <input type="Date" class="form-control datepicker-control" name="test_date" required="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pr-1"; }?>">
                      <div class="form-group">
                        <label>Hospital number  </label>
                         <input type="text" class="form-control" name="Hnumber" placeholder="Hosptial number" >
                    ...
                    <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "px-1"; }?>">
					 ...
					 <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pr-1"; }?>">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nhs_number" placeholder="NHS Number">
                      </div>
                    </div>
					         ...
					         <!-- <div class="col-md-4  <?php if($this->agent->is_mobile()){ echo "px-1" ; }else{ echo "pr-1"; }?>">
                       <div class="form-group">
                        <label>Specimen   <span class="text-theme">*</span></label>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="exampleInputEmail1"><h4 class="card-title mb-0 mt-0">Invoice Values: </h4> </label>
