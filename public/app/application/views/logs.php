            ...
            <div class="content pt-3">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content"><span class="text-theme  bootstrap-table">Logs</span>
                                    <div class="toolbar">
                                       ...
                                       <thead>
                                        ...
                                        <?php foreach($AllLogs as $job){ ?>
                                            ...
                                            <tr >
                                                ...
                                                <td><?php echo $job->user_action?></td>
                                                <td>
                                                   <?php $date = date_create($job->date);  echo  date_format($date,$dateFormat." H:i:s") ?>
                                                 </td>
        ...
        var $table = $('.mytable');
            ...
            $().ready(function(){
                ...
                $table.bootstrapTable({
                    ...
                    showRefresh: false,
                    search: true,
                   <?php if(isset($_GET['DoctorLoggedIn'])){ ?>  searchText:"Doctor has login", <?php }?>
                    showToggle: true,
                    showColumns: true,
                    pagination: false,
                    searchAlign: 'left',
