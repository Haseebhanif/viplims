   ...
   <tbody>
      <tr>
         <td style="padding-right:10px;padding-left:10px;" id="bodyCell" valign="top" align="center">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td style="padding-top: 40px; padding-bottom: 40px;" class="emailLogo" valign="middle" align="center">
                                             ...
                                             <img src="<?php echo base_url()?>assets/img/logo.png" alt="" style="width: 100%; max-width: 250px; height: auto; display: block;" class="" width="250" border="0">
                                             </a>
                                          </td>
                                       </tr>
                                    </tbody>
            ...
            <tbody><tr>
              <!-- Header Top Border // -->
              <td style="background-color: rgb(174, 26, 65); font-size: 1px; line-height: 3px;" class="topBorder" height="3">&nbsp;</td>
            </tr>
            ...
            <tr>
              <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" class="mainTitle" valign="top" align="center">
                <!-- Main Title Text // -->
                <h2 class="text" style="color: rgb(0, 0, 0); font-family: &quot;Poppins&quot;, Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 500; font-style: normal; letter-spacing: normal; line-height: 36px; text-transform: none; text-align: center; padding: 0px; margin: 0px;" data-font="active">You are almost there!</h2>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;" class="subTitle" valign="top" align="center">
                <!-- Sub Title Text // -->
                <h4 class="text" style="color:#999999; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:14px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:24px; text-transform:none; text-align:center; padding:0; margin:0">Please return to the login page and insert the Code,</h4>
              </td>
            </tr>
              ...
              <td style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable" valign="top" align="center">
                ...
                <table class="tableDescription" style="" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr>
                    <td style="padding-bottom: 20px;" class="description" valign="top" align="center">
                      <!-- Description Text// -->
                      <p class="text" style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0"></p>
                    </td>
                  </tr>
                </tbody></table><table class="tableMediumTitle" style="" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr>
                    <td style="padding-bottom: 20px;" class="mediumTitle" valign="top" align="center">
                      <!-- Medium Title Text // -->
                      <p class="text" style="color: rgb(174, 26, 65); font-family: &quot;Poppins&quot;, Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 300; font-style: normal; letter-spacing: normal; line-height: 24px; text-transform: none; text-align: center; padding: 0px; margin: 0px;">
                        USE CODE: <?php echo $Verification_code?>
                      </p>
                    </td>
                  </tr>
                </tbody></table>
                ...
                <table class="tableDescription" style="" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr>
                    <td style="padding-bottom: 20px;" class="description" valign="top" align="center">
                      <!-- Description Text// -->
                      <p class="text" style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">This code will expire in 2 minutes.</p>
                    </td>
                  </tr>
                </tbody></table><table class="tableDescription" style="" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody><tr>
                    <td style="padding-bottom: 20px;" class="description" valign="top" align="center">
                      <!-- Description Text// -->
                      <p class="text" style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0"></p>
            ...
            <tr><td style="padding-bottom: 40px;" class="emailRegards" valign="middle" align="center">
                        <!-- Image and Link // -->
                        <a href="#" target="_blank" style="text-decoration:none;" class="">
                            <img mc:edit="signature" src="<?php echo base_url();?>assets/img/logo.png" alt="" style="width:100%;
max-width:150px; height:auto; display:block;" class="" width="150" border="0">
                        </a>
                    </td>
</tr>
          </tbody></table>
                                    ...
                                    <tbody>
                                       <?php /*?><tr>
                                          <td style="padding: 10px 10px 5px;" class="brandInfo" valign="top" align="center">
                                             <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">&copy;&nbsp;Visiopath Inc.
                                             </p>
                                          </td>
                                       </tr><?php */?>
                                       <tr>
                                          <td style="padding: 0px 10px 20px;" class="footerLinks" valign="top" align="center">
                                             <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                               <a href="https://www.viplims.com/app/admin" style="color:#777777;text-decoration:underline;" target="_blank">Viplims</a>
                                             </p>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td style="padding: 0px 10px 10px;" class="footerEmailInfo" valign="top" align="center">
                                             <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                                if you have any questions contact us on <a href="mailto:info@Viplims.com"  style="color:#777777;text-decoration:underline;" target="_blank">info@Viplims.com</a><br>
                                             </p>
                                          </td>
                                       </tr>
                                       <tr>
