                                    ...
                                    <form method='get'>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo base_url();?>doctor/DoctorInvoice" class="mt-2 btn btn-outline-danger btn-theme">Reset</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <table id="bootstrap-table" class="table-striped">
                                        <span class="text-theme bootstrap-table ">Invoices</span>
                                        <thead>
                                        ...
                                        <?php foreach($jobDetails as $job){ ?>
                                            ...
                                            <?php if($job->doctor_sent == 0){?>
                                            <a class="btn btn-outline-danger btn-theme" href="<?php echo base_url();?>doctor/SendInvoice/<?php echo $job->test_id?>">
                                                    Send Invoice
                                                </a>
                                            <?php }elseif($job->doctor_sent == 1){?>
                             ...
                             <a href="<?php echo base_url();?>doctor/AllDoctorInvoiceexport<?php echo $startdate.$enddate; ?>" class="btn btn-outline-danger btn-theme mb-5 btn-wd">Export Invoice CSV</a>
                        </div> <!-- end col-md-12 -->
                    </div> <!-- end row -->
                </div>
            </div>
