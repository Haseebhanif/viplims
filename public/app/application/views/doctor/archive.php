                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                  ...
                                  <span class="text-theme  bootstrap-table">Archive</span>
                                    <div class="toolbar">
                                        <!--Here you can write extra buttons/actions for the toolbar-->
                                    </div>
                                    <table id="bootstrap-table" class="table-striped mytable">
                                        <thead>
                                           <th data-field="action" class="">Actions</th>
                                            ...
                                            <tr id="<?php echo $job->test_id?>">
                                              <td> 
                                                ...
                                                <td><a class="profile_link" href="<?php echo base_url();?>hospital/HospitalDetails/<?php echo $job->hospital_id?>"> <?php  
                                                    ...
                                                    <td <?php if($job->box_received == 0 ){ ?> class="text-center" <?php  }?> >
     ...
     $(document).ready(function(){
      //$('.SetBoxReceived').change(function(){ 
        ...
        var postId = $(this).attr("value");
            ...
            var retVal = confirm("Once you set you can not change \nAre you sure?");
                   if( retVal == true ) {
