...
<head>
	...
	<title>Completed Job By Doctor - Lims</title>
                                    ...
                                    <table id="bootstrap-table" class="table-striped">
                                        ...
                                        <?php foreach($jobDetails as $job){ ?>
											...
											<?php }?>
                                                ...
                                                <td>
                                                	<a class="profile_link" href="<?php echo base_url();?>user/PatientDetails/<?php echo $job->patient_id?>">
                                                		<?php echo $job->patient_name." ".$job->last_name?>
                                                	</a> <br /><small> DOB: <?php $date=date_create($job->DateOfBirth); echo date_format($date,$dateFormat); ?>
                                                </td>
