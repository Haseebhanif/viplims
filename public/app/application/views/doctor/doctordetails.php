                    ...
                    <div class="content">
                        ...
                        <div class="container-fluid">
                            <div class="col-md-12 bg-white pt-3 pb-3 brd-10 ">
                                ...
                                <span class="text-theme  bootstrap-table mt-3 mb-3 d-block">Doctor Details</span>

                                <a target="blank" class="btn btn-outline-danger btn-theme login_btn mb-3" href="<?php echo base_url();?>messages/AddMessage?id=<?php echo $DoctorDetails[0]->id ?>&name=<?php echo $DoctorDetails[0]->first_name ?>">Send message to <?php echo $DoctorDetails[0]->first_name ?> </a>

                                <div class="row pb-4">

                                    <div class="col-lg-4">
                                        <span class="patient-value ">Name of doctor</span>
                                        <br />
                                        <span class="patient-field"><?php echo 'Dr. '.$DoctorDetails[0]->doctor_name ?></span>
                                    </div>
                                    ...
                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        ...
                                        <span class="patient-field">
                                          <?php  echo $DoctorDetails[0]->email; ?>
                                        </span>
                                    </div>

                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        <span class="patient-value">Mobile number</span>
                                        <br />
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        <span class="patient-value">Secondary email</span>
                                        <br />
                                        <span class="patient-field"> <?php echo $DoctorDetails[0]->secondary_email;  ?></span>
                                    </div>

                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        <span class="patient-value">Work number</span>
                                        <br />
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-lg-4">
                                        <span class="patient-value">Gmc number</span>
                                        <br />

                                        <span class="patient-field"> 
                                          <?php echo $DoctorDetails[0]->gmc_number?>
                                        </span>
                                    </div>

                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        <span class="patient-value">Doctor specialties</span>
                                        <br />
                                        <span class="patient-field"> <?php echo $DoctorDetails[0]->doctor_specialties?></span>
                                    </div>

                                    <div class="col-lg-4 <?php if($this->agent->is_mobile()){ echo "mt-5" ; }?>">
                                        <span class="patient-value">Department</span>
                                        <br />
                                        <span class="patient-field"> 
                         ...
                         ?>
                                                    ...
                                                    <td>
                                                        <a class="profile_link" href="<?php echo base_url();?>user/PatientDetails/<?php echo $detail->patient_primary_id; ?>"><?php  echo $detail->patient_name; ?> <?php  echo $detail->last_name; ?></a>
                                                        <br /><small> DOB: <?php $date=date_create($detail->DateOfBirth); echo date_format($date,$dateFormat); ?>
                                                    </td>
                                                     <td>
                                                        <?php if($detail->authorised == '1'){ ?>
