            ...
            <div class="content pt-3">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content"><span class="text-theme  bootstrap-table">View All Reports</span>
                                    <div class="toolbar">
                                    ...
                                    <table id="bootstrap-table" class="table-striped">
                                        <thead>
                                           ...
                                           <th data-field="name" data-sortable="true">Patient Name </th>
											 <th data-field="visonumber" data-sortable="true">Visiopath # </th>
											<th data-field="hospital_number" data-sortable="true">Hospital # </th>
                                            
											<th data-field="dotor" data-sortable="true">Doctor name</th>
											<th data-field="hospital" data-sortable="true">Referring Institute</th>
                                            ...
                                            <tr id="<?php echo $job->test_id?>">
                                                <td>
                                                    <div class="">
                                                            ...
                                                            <a target="_blank" title="Print Report" class="btn btn-simple btn-warning btn-icon table-action edit" href="<?php echo base_url();?>report/view/<?php echo $job->test_id?>" data-original-title=""><i class="ti-printer"></i></a>
                                                    </div>
                                                </td>
                                                ...
                                                <td><?php $date=date_create($job->test_date); echo date_format($date,$dateFormat); ?>
