...
<head>
	...
	<title>Add From Existing - Lims</title>
...
<body>
	<div class="wrapper">
	    ...
	    <div class="main-panel">
          ...
          <?php /*?><div class="col-lg-3 col-md-6 col-sm-6 mt-3">
            ...
            <div class="content pt-3">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content"> <span class="text-theme  bootstrap-table">Choose Existing Patient</span>
                                    <div class="toolbar">
                                    ...
                                    <table id="bootstrap-table" class="table-striped">
                                        <thead>
                                            ...
                                            <th data-field="id" data-sortable="true">Patient Id</th>
                                        ...
                                        <?php foreach($patients as $patient){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $patient->patient_name.' '.$patient->last_name ?></td>
                                                <td><?php echo $patient->gender?></td>
                                                <td><?php $date=date_create($patient->DateOfBirth); echo date_format($date,"d-m-Y"); ?> </td>
