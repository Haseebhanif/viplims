	    ...
	    <div class="main-panel">
          ...
          <div class="col-lg-12 col-md-6 col-sm-6">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 pull-left mt-2">  
              <a href="<?php echo base_url()?>messages" class="btn btn-outline-danger btn-theme login_btn ">Inbox</a>

              <a href="javascript:;" class="btn btn-outline-danger btn-theme login_btn active">Sent</a>
            </div>
                                           ...
                                           <?php foreach($messages as $message){ 
                                            $date = date_create($message->message_time);?>
                                                <tr>
                                                    ...
                                                    <td>
                                                      <a href="<?php echo base_url();?>messages/ShowMessage/<?php echo $message->message_id?>">
