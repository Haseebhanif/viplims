...
<body>
	<div class="wrapper">
	    ...
	    <div class="main-panel">
          ...
          <a class='btn btn-outline-danger login_btn' href="https://www.reviewschef.com/lims_system/admin/Addhospital">Add institute</a>
                        ...
                        <div class="card"> 
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        <div class="numbers">
                                            <p>Number of cases authorized</p>

                                            <?php echo $casesAuthorised[0]->total;?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card"> 
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        <div class="numbers">
                                            <p>Cases booked in  <sup> but not allocated </sup></p>
