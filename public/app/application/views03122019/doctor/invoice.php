                                    ...
                                    <table id="bootstrap-table" class="table">
                                      ...
                                      <?php foreach($jobDetails as $jobDetail){ ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>user/PatientDetails/<?php echo $jobDetail->test_id ?>"><?php echo $jobDetail->patient_name ?></a> </td>
              ...
              foreach($testTypes as $test){ 
               ...
               ?></td>
                                                ...
                                                <td><?php  foreach($doctors as $doctor){ 
                                                 ...
                                                 <td><a href="#" class="btn btn-outline-danger btn-theme login_btn" data-toggle="modal" data-target="#exampleModalCenter<?php echo $jobDetail->test_id ?>">View Invoice</a></td>
                                            </tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" id="print2">
       ...
       <div class="row  pb-3">
        ...
        <div class="row  pb-3">
         <div class="col-md-6 ">
           ...
           <span><?php  foreach($testTypes as $test){ 
                            if($test->TestTypeId == $jobDetail->specimen ){
                                echo $test->TestTypeName;
                            }
                        } ?></span>
      ...
      <div class="modal-footer">
        <a href="<?php echo base_url()?>doctor/GetInvoiceDownload/<?php echo $jobDetail->test_id ?>" target="_blank"  class="btn btn-theme">Download</a>

         <a href="<?php echo base_url()?>doctor/GetInvoiceDownload/<?php echo $jobDetail->test_id ?>" target="_blank"  class="btn btn-theme">Print</a>
