	    ...
	    <div class="main-panel">
          ...
          <div class="col-lg-12 col-md-6 col-sm-6">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 pull-left mt-2">  
              <a href="javascript:;" class="btn btn-outline-danger btn-theme login_btn active">Inbox</a>

              <a href="<?php echo base_url()?>messages/SentMessages" class="btn btn-outline-danger btn-theme login_btn">Sent</a>
            </div>
                                           ...
                                           <?php foreach($messages as $message){  //print_r($message);
                                            $date = date_create($message->message_time);?>
                                                <tr>
                                                    ...
                                                    <td>
                                                      <a href="<?php echo base_url();?>messages/ShowMessage/<?php if(!empty($message->message_parent_id)){ echo $message->message_parent_id;}else{ echo $message->message_id;}?>">
