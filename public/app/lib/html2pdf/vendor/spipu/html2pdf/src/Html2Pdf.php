...
class Html2Pdf
{
     ...
     * @return boolean
     */
    protected function _tag_open_NAV($param)
    {
     ...
     * @return boolean
     */
    protected function _tag_close_NAV($param)
    {
...
<html>
   ...
   /**
    ...
    protected function _tag_open_TITLE($param)
        {

            return true ; 
        }

        protected function _tag_close_TITLE($param)
        {
            return true ;
        }
}
