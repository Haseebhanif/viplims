...
$CONFIG = [
	...
	"RANDOM_KEY" => 'oGzK3hq2sxBmjwc3', // Random key for encryption
	...
	"PROJECT_ID" => "{66D9B652-4AC2-46C2-B52C-5398482C1EA8}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "lims"]
	],
