 ...
 * Page class
 */
class config_options_add extends config_options
{
	...
	// Page object name
	public $PageObjName = "config_options_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("config_optionslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "config_optionslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "config_optionsview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// parent_id
		$this->parent_id->setDbValueDef($rsnew, $this->parent_id->CurrentValue, 0, FALSE);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("config_optionslist.php"), "", $this->TableVar, TRUE);
