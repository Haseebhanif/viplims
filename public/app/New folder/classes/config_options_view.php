 ...
 * Page class
 */
class config_options_view extends config_options
{
	...
	// Page object name
	public $PageObjName = "config_options_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "config_optionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "config_optionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "config_optionslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
