...
<?php $__env->startSection('container'); ?>
    ...
    <div class="buttons">
        ...
        <a href="<?php echo e(route('login')); ?>" class="button">Login as Admin</a>
    </div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saasthemes/public_html/domains/viplims.com/resources/views/vendor/installer/finished.blade.php ENDPATH**/ ?>