    ...
    <section class="pricing-sec-min">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                <div class="Main-div">
                        <form type="post" action="<?php echo e(route('user_package.donation_store','1')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saasthemes/public_html/domains/viplims.com/resources/views/donation.blade.php ENDPATH**/ ?>